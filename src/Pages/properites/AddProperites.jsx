          ...
          >
            <div className=' flex space-x-3 w-full'>
              <div className='w-full space-y-2'>
                ...
                <FormControl>
                  <FormLabel className='focus-visible:border-black'>bedrooms :</FormLabel>
                  <Input
                    type='number'
                    name='bedrooms'
                ...
                <FormControl>
                  <FormLabel className='focus-visible:border-black'>Bathrooms :</FormLabel>
                  <Input
                    type='number'
                    name='bathrooms'
                ...
                <FormControl>
                  <FormLabel className='focus-visible:border-black'>Delivery in :</FormLabel>
                  <Input
                    type='number'
                    name='delivery_in'
                ...
                <FormControl>
                  <FormLabel className='focus-visible:border-black'>Longitude :</FormLabel>
                  <Input
                    type='number'
                    name='longitude'
                ...
                <FormControl>
                  <FormLabel className='focus-visible:border-black'>Balconies :</FormLabel>
                  <Input
                    type='number'
                    name='balconies'
                ...
                <FormControl>
                  <FormLabel className='focus-visible:border-black'>Grage :</FormLabel>
                  <Input
                    type='number'
                    name='grage'
